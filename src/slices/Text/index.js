...
const Text = ({ slice }) => {
  ...
  const richTextCustomRender = {
    ...
    heading1: ({ children }) => <h1 style={{ color: slice.primary.text_color, fontWeight: "700", fontSize: "2.5rem" }}>{children}</h1>,
    heading2: ({ children }) => <h2 style={{ color: slice.primary.text_color, fontWeight: "700", fontSize: "2rem" }}>{children}</h2>,
